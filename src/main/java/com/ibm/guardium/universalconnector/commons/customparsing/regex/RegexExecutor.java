...
public class RegexExecutor {
     ...
     * @return A RegexResult containing all relevant attributes of the regex match
     */
    public RegexResult find(Pattern p, String source, int startIndex) {
        return find(p, source, startIndex, DEFAULT_TIMEOUT_MICRO, DEFAULT_TIMING);
    }
     ...
     * @return A RegexResult containing all relevant attributes of the regex match
     */
    public RegexResult find(Pattern p, String source, long timeout) {
        return find(p, source, 0, timeout, DEFAULT_TIMING);
    }
     ...
     * @return A RegexResult containing all relevant attributes of the regex match
     */
    public RegexResult find(Pattern p, String source, boolean timing) {
        return find(p, source, 0, DEFAULT_TIMEOUT_MICRO, timing);
    }
     ...
     * @return A RegexResult containing all relevant attributes of the regex match
     */
    public RegexResult find(Pattern p, String source, long timeout, boolean timing) {
        return find(p, source, 0, timeout, timing);
    }
     ...
     * @return A RegexResult containing all relevant attributes of the regex match
     */
    public RegexResult find(Pattern p, String source, int startIndex, long timeout) {
        return find(p, source, startIndex, timeout, DEFAULT_TIMING);
    }
     ...
     * @return A RegexResult containing all relevant attributes of the regex match
     */
    public RegexResult find(Pattern p, String source, int startIndex, boolean timing) {
        return find(p, source, startIndex, DEFAULT_TIMEOUT_MICRO, timing);
    }
